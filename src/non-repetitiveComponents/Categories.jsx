         ...
         <div>
            <div className=' 2xl:ps-44 xl:ps-44 lg:ps-44 md:ps-0  mt-24  bg-[#232321]'>
                  ...
                  <div className='flex justify-between'>
                     <h1 className='text-white pt-16  2xl:text-[4rem] xl:text-[3.8rem] lg:text-[3.5rem]  md:text-[3em]  font-semibold font-rubik leading-normal p '>Categories</h1>
                  ...
                  <div className='flex flex-col md:flex-row'>
                     ...
                     <div className='2xl:w-[50%]  xl:w-[50%] lg:w-[50%] md:w-[100%] xl:h-[40rem] lg:h-[35rem] h-[40rem]   mt-[3.2rem] rounded-tl-[64px]  bg-[#ECEEF0]'>

                        <div className="2xl:w-[70%] xl:w-[27rem] lg:w-[24rem] xl:h-60 2xl:h-64 mt-48  2xl:ms-[10rem] xl:ms-[10rem] lg:ms-[3rem]  overflow-hidden">
                        ...
                        <div className='flex justify-between 2xl:mt-6 xl:mt-6 lg:mt-6 items-center'>
                           <h1 className=' ps-16 pt-12  text-[#232321] font-rubik 2xl:text-[2.25rem]   xl:text-[2rem] lg:text-[1.8rem]   font-semibold leading-normal uppercase'>Lifestyle <span className='block leading-[35px]'>Shoes</span></h1>

                           <button className="rounded-[0.5rem] mb-5 mt-[4.7rem] me-16 bg-[#232321] hover:bg-[#005F73] 2xl:h-12 xl:h-10 lg:h-8 px-7 py-8 flex justify-center items-center gap-1 text-white font-rubik text-sm leading-normal tracking-[0.01563rem] uppercase transition-all duration-300">
                     ...
                     <div className='2xl:w-[50%]  xl:w-[50%] lg:w-[50%] xl:h-[40rem] lg:h-[35rem] h-[40rem] mt-[3.2rem]   bg-[#F6F6F6]'>


                        <div className="2xl:w-[70%] xl:w-[27rem] lg:w-[24rem] md:w-[100%]   2xl:mt-48 xl:mt-48 lg:mt-36 2xl:ms-[10rem] xl:ms-[6rem] lg:ms-[3rem]">
                           <img
                              className=" object-cover  object-center"
                        ...
                        <div className='flex justify-between 2xl:mt-[0.5rem] xl:mt-[0.5rem] lg:mt-[0.5rem] items-center'>
                           <h1 className=' ps-16 pt-12  text-[#232321] font-rubik  2xl:text-[2.25rem]   xl:text-[2rem] lg:text-[1.8rem]  font-semibold leading-normal uppercase'>Basketball <span className='block leading-[35px]'>Shoes</span></h1>
