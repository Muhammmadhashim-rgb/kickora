...
export default class Categories extends Component {
   render() {
      return (
         <div>
            <div className=' ps-44 mt-24  bg-[#232321]'>
               ...
               <div className='flex flex-col md:flex-row'>
                  ...
                  <div className='2xl:w-[50%]  xl:w-[50%] lg:w-[50%] xl:h-[40rem] lg:h-[35rem] h-[40rem]   mt-[3.2rem] rounded-tl-[64px]  bg-[#ECEEF0]'>
                  ...
                  <div className='2xl:w-[50%]  xl:w-[50%] lg:w-[50%] xl:h-[40rem] lg:h-[35rem] h-[40rem] mt-[3.2rem]   bg-[#F6F6F6]'>
                     ...
                     <div className="2xl:w-[70%] xl:w-[27rem] lg:w-[24rem]  2xl:mt-48 xl:mt-48 lg:mt-36 2xl:ms-[10rem] xl:ms-[6rem] lg:ms-[3rem]">
                        <img
                           className=" object-cover  object-center"
