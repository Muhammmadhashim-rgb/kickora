      ...
      <div>
        ...
        <div className=' w-full pt-[72px] px-[72px] mt-[-60px] rounded-[3rem] bg-[#232321] overflow-clip'>
          <div className='flex 2xl:gap-52 xl:gap-[6rem]'>
            ...
            <div>
              <h1 className='text-[1.5rem] font-rubik font-[600] text-[#FFA52F]'>Categories</h1>
              <ul className='mt-3'>
                <li>
                  <p className='text-[1.25rem] cursor-pointer font-sans-serif font-normal text-[#E7E7E3]'>Runners</p>
                </li>
                <li>
                  <p className='text-[1.25rem] cursor-pointer font-sans-serif font-normal text-[#E7E7E3]'>Sneakers</p>
                </li>
                <li>
                  <p className='text-[1.25rem]  cursor-pointer font-sans-serif font-normal text-[#E7E7E3]'>Hiking</p>
                </li>
                <li>
                  <p className='text-[1.25rem] cursor-pointer  font-sans-serif font-normal text-[#E7E7E3]'>Golf</p>
                </li>
                <li>
                  <p className='text-[1.25rem] cursor-pointer  font-sans-serif font-normal text-[#E7E7E3]'>Outdoor</p>
                </li>
                <li>
                  <p className='text-[1.25rem] cursor-pointer  font-sans-serif font-normal text-[#E7E7E3]'>Basketball</p>
                </li>
              </ul>
            </div>
            <div>
              <h1 className='text-[1.5rem] font-rubik font-[600] text-[#FFA52F]'>Company</h1>
              <ul className='mt-3'>
                <li>
                  <p className='text-[1.25rem] font-sans-serif font-normal cursor-pointer  text-[#E7E7E3]'>About</p>
                </li>
                <li>
                  <p className='text-[1.25rem] font-sans-serif font-normal cursor-pointer  text-[#E7E7E3]'>Contact</p>
                </li>
                <li>
                  <p className='text-[1.25rem] font-sans-serif font-normal cursor-pointer  text-[#E7E7E3]'>Blogs</p>
                </li>
              </ul>
            </div>
            <div>
              <h1 className='text-[1.5rem] font-rubik font-[600] text-[#FFA52F]'>Follow us</h1>
              <ul className='flex gap-5 mt-3'>
                <li>
                  <p className='text-[1.25rem] cursor-pointer font-sans-serif font-normal text-[#E7E7E3]'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <li>
                  <p className='text-[1.25rem] cursor-pointer font-sans-serif font-normal text-[#E7E7E3]'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
