...
function ReviewsCarts(props) {
  ...
  return (
    <div>
      <div className='reviewsbackground w-[29rem] bg-white h-[28rem] rounded-[2rem]'>
        <div className='p-[30px]'>
          ...
          <p className='font-sans-serif text-[1.1rem] pr-[23px]'>{props.para}</p>
          ...
          <div className='mt-[18px] flex gap-[5px] '>
            ...
            <p className='font-rubik text-[1.2rem] items-center'>{props.data}</p>
          </div>
        </div>
